...
function transformArguments(key, members, options) {
    ...
    for (const { score, value } of (Array.isArray(members) ? members : [members])) {
        args.push(generic_transformers_1.transformArgumentNumberInfinity(score), value);
    }
    return args;
}
exports.transformArguments = transformArguments;
exports.transformReply = generic_transformers_1.transformReplyNumberInfinity;
